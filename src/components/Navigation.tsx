        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-4 gap-3">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-white border-2 border-gray-200 rounded-lg px-4 py-2.5 pr-10 text-sm font-medium text-gray-700 hover:border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 min-w-[220px] shadow-sm transition-all duration-200"
            >
